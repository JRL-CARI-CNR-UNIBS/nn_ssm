...
max_epochs = 5000;
hiddenLayerSize = [10,10,10,10,10,10,10,10,10,10,10,10,10,10,10]; %[50,50,50,50,50,50]
ws_save = "nn_scaling_"+string(mat2str(hiddenLayerSize))+".mat";
...
% input = (input+ones(size(input)))./(2*ones(size(input)));
